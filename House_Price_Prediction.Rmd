...
```
```{r}
#PC1 , PC2 explains more variance with Garage Area
#PC3 explains more variance with Lot Area
#PC4 explains more variance with Pool Area
#PC5 explains more variance with Total Live Area
```
...
library(psych)
fit.pc <- principal(training_fca, nfactors=3, rotate="varimax")
